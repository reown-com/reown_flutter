...
// import 'package:reown_sign/models/auth_client_models.dart';
import 'package:reown_sign/models/session_auth_models.dart';

part 'cacao_models.g.dart';
...
class CacaoRequestPayload with _$CacaoRequestPayload {
  ...
  factory CacaoRequestPayload.fromPayloadParams(SessionAuthPayload params) {
