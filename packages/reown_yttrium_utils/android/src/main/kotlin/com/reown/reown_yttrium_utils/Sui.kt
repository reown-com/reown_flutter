...
class Sui(private val projectId: String, private val networkId: String, private val pulseMetadata: PulseMetadata) {
    ...
    companion object {
        ...
        fun init(applicationContext: Context, params: Any?, result: MethodChannel.Result) {
            ...
            val packageName = applicationContext.packageName ?: pulseMetadataDict["bundleId"] as? String ?: return errorMissing("bundleId", params, result)
            ...
            val pulseMetadata = PulseMetadata(url = url, bundleId = packageName, sdkVersion = sdkVersion, sdkPlatform = sdkPlatform)
