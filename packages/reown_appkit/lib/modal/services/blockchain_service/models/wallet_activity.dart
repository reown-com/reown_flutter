...
class ActivityData {
  ...
  ActivityData({this.data, this.next});
...
class Activity {
  ...
  Activity({this.id, this.metadata, this.transfers});
...
class Application {
  ...
  Application({this.name, this.iconUrl});
  ...
  factory Application.fromJson(Map<String, dynamic> json) =>
      Application(name: json['name'], iconUrl: json['iconUrl']);
...
class FungibleInfo {
  ...
  FungibleInfo({this.name, this.symbol, this.icon});
...
class Icon {
  ...
  factory Icon.fromJson(Map<String, dynamic> json) => Icon(url: json['url']);
...
class NftInfo {
  ...
  NftInfo({this.name, this.content, this.flags});
...
class Content {
  ...
  Content({this.preview, this.detail});
  ...
  factory Content.fromJson(Map<String, dynamic> json) => Content(
    preview: json['preview'] == null ? null : Detail.fromJson(json['preview']),
...
class Detail {
  ...
  Detail({this.url, this.contentType});
  ...
  factory Detail.fromJson(Map<String, dynamic> json) =>
      Detail(url: json['url'], contentType: json['content_type']);

  Map<String, dynamic> toJson() => {'url': url, 'content_type': contentType};
}
...
class Flags {
  ...
  factory Flags.fromJson(Map<String, dynamic> json) =>
      Flags(isSpam: json['is_spam']);

  Map<String, dynamic> toJson() => {'is_spam': isSpam};
}
...
class Quantity {
  ...
  factory Quantity.fromJson(Map<String, dynamic> json) =>
      Quantity(numeric: json['numeric']);

  Map<String, dynamic> toJson() => {'numeric': numeric};
}
