...
class ActivityListItem extends StatelessWidget {
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: RoundedIcon(imageUrl: tokenImage, size: 15.0),
                ),
              ),
            ],
          ),
                        ...
                        WidgetSpan(
                          child: RoundedIcon(
                            ...
                            circleColor: confirmed
                                ? themeColors.success100.withValues(alpha: 0.1)
                                : themeColors.grayGlass010,
                            borderColor: confirmed
                                ? themeColors.success100.withValues(alpha: 0.15)
  ...
  String _subtitle(OperationType operationType) {
    ...
    final transferValue1 = transfers.isNotEmpty
        ...
        : null;
    final transferSymbol1 = transfers.isNotEmpty
    ...
    final transferValue2 = transfers.length > 1
        ...
        : null;
    final transferSymbol2 = transfers.length > 1
        ? transfers.last.fungibleInfo?.symbol
        : null;
    //
      ...
      child: Row(
        children: [
          ...
          Padding(
            ...
            child: AspectRatio(
              aspectRatio: 1.0,
              child: CircleAvatar(backgroundColor: themeColors.grayGlass010),
            ),
          ),
          Expanded(
            child: Padding(
