...
class KeyConstants {
  ...
  static const Key closeModalButtonKey = Key('closeModalButtonKey');
  static const Key getAWalletButtonKey = Key('getAWalletButtonKey');
  static const Key navbarBackButtonKey = Key('navbarBackButtonKey');
  static const Key gridListViewAllButtonKey = Key('gridListViewAllButtonKey');
}
