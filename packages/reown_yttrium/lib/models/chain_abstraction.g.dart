...
Map<String, dynamic> _$$MetadataCompatImplToJson(
    ...
    <String, dynamic>{
      'fundingFrom': instance.fundingFrom,
      'initialTransaction': instance.initialTransaction,
...
Map<String, dynamic> _$$UiFieldsCompatImplToJson(
    ...
    <String, dynamic>{
      'routeResponse': instance.routeResponse,
      'route': instance.route,
      'localRouteTotal': instance.localRouteTotal,
      'bridge': instance.bridge,
      'localBridgeTotal': instance.localBridgeTotal,
      'initial': instance.initial,
      'localTotal': instance.localTotal,
    };
