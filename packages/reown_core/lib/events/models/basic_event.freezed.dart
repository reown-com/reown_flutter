...
mixin _$CoreEventProperties {
 ...
 String? get message; String? get name; String? get method; bool? get connected; String? get namespace; String? get network; String? get caipNetworkId; String? get explorerId; int? get walletRank; int? get displayIndex; String? get view; String? get provider; String? get platform; List<String>? get trace; String? get topic; int? get correlation_id; String? get client_id; String? get direction; String? get userAgent; String? get sendToken; String? get sendAmount; String? get address; String? get project_id; String? get cursor; Map<String, String>? get exchange; Map<String, String>? get configuration; Map<String, String>? get currentPayment; String? get source; bool? get headless; bool? get reconnect; String? get link; String? get linkType; bool? get showWallets; Map<String, dynamic>? get siweConfig; String? get themeMode;//   themeVariables?: ThemeVariables
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? message,  String? name,  String? method,  bool? connected,  String? namespace,  String? network,  String? caipNetworkId,  String? explorerId,  int? walletRank,  int? displayIndex,  String? view,  String? provider,  String? platform,  List<String>? trace,  String? topic,  int? correlation_id,  String? client_id,  String? direction,  String? userAgent,  String? sendToken,  String? sendAmount,  String? address,  String? project_id,  String? cursor,  Map<String, String>? exchange,  Map<String, String>? configuration,  Map<String, String>? currentPayment,  String? source,  bool? headless,  bool? reconnect,  String? link,  String? linkType,  bool? showWallets,  Map<String, dynamic>? siweConfig,  String? themeMode,  List<String>? networks,  String? defaultNetwork,  List<String>? chainImages,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CoreEventProperties() when $default != null:
return $default(_that.message,_that.name,_that.method,_that.connected,_that.namespace,_that.network,_that.caipNetworkId,_that.explorerId,_that.walletRank,_that.displayIndex,_that.view,_that.provider,_that.platform,_that.trace,_that.topic,_that.correlation_id,_that.client_id,_that.direction,_that.userAgent,_that.sendToken,_that.sendAmount,_that.address,_that.project_id,_that.cursor,_that.exchange,_that.configuration,_that.currentPayment,_that.source,_that.headless,_that.reconnect,_that.link,_that.linkType,_that.showWallets,_that.siweConfig,_that.themeMode,_that.networks,_that.defaultNetwork,_that.chainImages,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? message,  String? name,  String? method,  bool? connected,  String? namespace,  String? network,  String? caipNetworkId,  String? explorerId,  int? walletRank,  int? displayIndex,  String? view,  String? provider,  String? platform,  List<String>? trace,  String? topic,  int? correlation_id,  String? client_id,  String? direction,  String? userAgent,  String? sendToken,  String? sendAmount,  String? address,  String? project_id,  String? cursor,  Map<String, String>? exchange,  Map<String, String>? configuration,  Map<String, String>? currentPayment,  String? source,  bool? headless,  bool? reconnect,  String? link,  String? linkType,  bool? showWallets,  Map<String, dynamic>? siweConfig,  String? themeMode,  List<String>? networks,  String? defaultNetwork,  List<String>? chainImages,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _CoreEventProperties():
return $default(_that.message,_that.name,_that.method,_that.connected,_that.namespace,_that.network,_that.caipNetworkId,_that.explorerId,_that.walletRank,_that.displayIndex,_that.view,_that.provider,_that.platform,_that.trace,_that.topic,_that.correlation_id,_that.client_id,_that.direction,_that.userAgent,_that.sendToken,_that.sendAmount,_that.address,_that.project_id,_that.cursor,_that.exchange,_that.configuration,_that.currentPayment,_that.source,_that.headless,_that.reconnect,_that.link,_that.linkType,_that.showWallets,_that.siweConfig,_that.themeMode,_that.networks,_that.defaultNetwork,_that.chainImages,_that.metadata);}
}
...
class _CoreEventProperties implements CoreEventProperties {
  const _CoreEventProperties({this.message, this.name, this.method, this.connected, this.namespace, this.network, this.caipNetworkId, this.explorerId, this.walletRank, this.displayIndex, this.view, this.provider, this.platform, final  List<String>? trace, this.topic, this.correlation_id, this.client_id, this.direction, this.userAgent, this.sendToken, this.sendAmount, this.address, this.project_id, this.cursor, final  Map<String, String>? exchange, final  Map<String, String>? configuration, final  Map<String, String>? currentPayment, this.source, this.headless, this.reconnect, this.link, this.linkType, this.showWallets, final  Map<String, dynamic>? siweConfig, this.themeMode, final  List<String>? networks, this.defaultNetwork, final  List<String>? chainImages, final  Map<String, dynamic>? metadata}): _trace = trace,_exchange = exchange,_configuration = configuration,_currentPayment = currentPayment,_siweConfig = siweConfig,_networks = networks,_chainImages = chainImages,_metadata = metadata;
