...
// in reown_pos/test/blockchain_service_test.dart.
...
import 'package:reown_core/store/i_store.dart' as _i12;
...
class _FakeIStore_10<T> extends _i1.SmartFake implements _i12.IStore<T> {
  _FakeIStore_10(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeLogger_11 extends _i1.SmartFake implements _i13.Logger {
  _FakeLogger_11(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockReownCore extends _i1.Mock implements _i15.ReownCore {
  ...
  @override
  _i12.IStore<Map<String, dynamic>> get storage =>
      (super.noSuchMethod(
            Invocation.getter(#storage),
            returnValue: _FakeIStore_10<Map<String, dynamic>>(
              this,
              Invocation.getter(#storage),
            ),
          )
          as _i12.IStore<Map<String, dynamic>>);

  @override
  _i12.IStore<Map<String, dynamic>> get secureStorage =>
      (super.noSuchMethod(
  ...
  @override
  _i13.Logger get logger =>
      (super.noSuchMethod(
            Invocation.getter(#logger),
            returnValue: _FakeLogger_11(this, Invocation.getter(#logger)),
          )
          as _i13.Logger);
  ...
  @override
  set crypto(_i2.ICrypto? _crypto) => super.noSuchMethod(
    Invocation.setter(#crypto, _crypto),
    returnValueForMissingStub: null,
  );

  @override
  set relayClient(_i3.IRelayClient? _relayClient) => super.noSuchMethod(
    Invocation.setter(#relayClient, _relayClient),
    returnValueForMissingStub: null,
  );

  @override
  set expirer(_i4.IExpirer? _expirer) => super.noSuchMethod(
    Invocation.setter(#expirer, _expirer),
    returnValueForMissingStub: null,
  );

  @override
  set pairing(_i5.IPairing? _pairing) => super.noSuchMethod(
    Invocation.setter(#pairing, _pairing),
    returnValueForMissingStub: null,
  );

  @override
  set echo(_i6.IEcho? _echo) => super.noSuchMethod(
    Invocation.setter(#echo, _echo),
    returnValueForMissingStub: null,
  );

  @override
  set events(_i7.IEvents? _events) => super.noSuchMethod(
    Invocation.setter(#events, _events),
    returnValueForMissingStub: null,
  );

  @override
  set heartbeat(_i8.IHeartBeat? _heartbeat) => super.noSuchMethod(
    Invocation.setter(#heartbeat, _heartbeat),
    returnValueForMissingStub: null,
  );

  @override
  set verify(_i9.IVerify? _verify) => super.noSuchMethod(
  ...
  @override
  set linkModeStore(_i11.ILinkModeStore? _linkModeStore) => super.noSuchMethod(
    Invocation.setter(#linkModeStore, _linkModeStore),
    returnValueForMissingStub: null,
  );

  @override
  set storage(_i12.IStore<Map<String, dynamic>>? _storage) =>
      super.noSuchMethod(
  ...
  @override
  set secureStorage(_i12.IStore<Map<String, dynamic>>? _secureStorage) =>
      super.noSuchMethod(
...
class MockReownSign extends _i1.Mock implements _i15.ReownSign {
  ...
  set pendingProposals(
    List<_i15.SessionProposalCompleter>? _pendingProposals,
  ) => super.noSuchMethod(
    Invocation.setter(#pendingProposals, _pendingProposals),
    returnValueForMissingStub: null,
  );

  @override
  set pendingTVFRequests(Map<int, _i21.TVFData>? _pendingTVFRequests) =>
      super.noSuchMethod(
        Invocation.setter(#pendingTVFRequests, _pendingTVFRequests),
        returnValueForMissingStub: null,
      );

  @override
  set authKeys(_i16.IGenericStore<_i15.AuthPublicKey>? _authKeys) =>
      super.noSuchMethod(
        Invocation.setter(#authKeys, _authKeys),
        returnValueForMissingStub: null,
      );

  @override
  set pairingTopics(_i16.IGenericStore<String>? _pairingTopics) =>
      super.noSuchMethod(
        Invocation.setter(#pairingTopics, _pairingTopics),
        returnValueForMissingStub: null,
      );

  @override
  set sessionAuthRequests(
    _i16.IGenericStore<_i15.PendingSessionAuthRequest>? _sessionAuthRequests,
  ) => super.noSuchMethod(
    Invocation.setter(#sessionAuthRequests, _sessionAuthRequests),
    returnValueForMissingStub: null,
  );

  @override
  set pendingSessionAuthRequests(
    List<_i15.SessionAuthenticateCompleter>? _pendingSessionAuthRequests,
  ) => super.noSuchMethod(
    Invocation.setter(#pendingSessionAuthRequests, _pendingSessionAuthRequests),
    returnValueForMissingStub: null,
  );
