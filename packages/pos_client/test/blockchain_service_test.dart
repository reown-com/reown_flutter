...
import 'package:pos_client/services/pos_rpc_service.dart';
...
void main() {
  ...
  group('PosClient Tests', () {
    ...
    test('setTokens() configures tokens correctly', () {
      ...
      testPosClient.setTokens(tokens: tokens);

      expect(testPosClient.configuredTokens, equals(tokens));
      expect(testPosClient.configuredTokens.length, equals(2));
    });
    ...
    test('setTokens() throws error when empty tokens provided', () {
      ...
      expect(
        () => testPosClient.setTokens(tokens: []),
    ...
    test('posSupportedNetworks method works correctly', () async {
      ...
      final result = await testPosClient.posSupportedNetworks(
...
class TestPosClient extends PosClient {
