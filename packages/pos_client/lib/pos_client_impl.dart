...
import 'package:pos_client/services/validator_service.dart';
import 'package:pos_client/utils/extensions.dart';
import 'package:pos_client/utils/helpers.dart';

class PosClient with PosRpcService, ValidatorService implements IPosClient {
...
extension _PrivateMembers on PosClient {
