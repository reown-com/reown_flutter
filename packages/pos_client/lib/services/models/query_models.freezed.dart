...
abstract mixin class $QueryParamsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String projectId, String deviceId, String st, String sv});
}
...
extension QueryParamsPatterns on QueryParams {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String projectId, String deviceId, String st, String sv)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
mixin _$PaymentIntentParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PaymentIntentParamsCopyWith<PaymentIntentParams> get copyWith =>
      _$PaymentIntentParamsCopyWithImpl<PaymentIntentParams>(
          this as PaymentIntentParams, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, asset, amount, sender, recipient);
...
abstract mixin class $PaymentIntentParamsCopyWith<$Res> {
  factory $PaymentIntentParamsCopyWith(
          PaymentIntentParams value, $Res Function(PaymentIntentParams) _then) =
      _$PaymentIntentParamsCopyWithImpl;
  @useResult
  $Res call({String asset, String amount, String sender, String recipient});
}
...
extension PaymentIntentParamsPatterns on PaymentIntentParams {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PaymentIntentParams value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PaymentIntentParams() when $default != null:
        return $default(
            _that.asset, _that.amount, _that.sender, _that.recipient);
      case _:
        return orElse();
    }
  }
...
class _PaymentIntentParams implements PaymentIntentParams {
  const _PaymentIntentParams(
      {required this.asset,
      required this.amount,
      required this.sender,
      required this.recipient});
  factory _PaymentIntentParams.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PaymentIntentParamsCopyWith<_PaymentIntentParams> get copyWith =>
      __$PaymentIntentParamsCopyWithImpl<_PaymentIntentParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PaymentIntentParamsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PaymentIntentParamsCopyWith<$Res>
    implements $PaymentIntentParamsCopyWith<$Res> {
  factory _$PaymentIntentParamsCopyWith(_PaymentIntentParams value,
          $Res Function(_PaymentIntentParams) _then) =
      __$PaymentIntentParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String asset, String amount, String sender, String recipient});
}
...
mixin _$BuildTransactionParams {
  List<PaymentIntentParams> get paymentIntents;
  ...
  $BuildTransactionParamsCopyWith<BuildTransactionParams> get copyWith =>
      _$BuildTransactionParamsCopyWithImpl<BuildTransactionParams>(
          this as BuildTransactionParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is BuildTransactionParams &&
            const DeepCollectionEquality()
                .equals(other.paymentIntents, paymentIntents) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(paymentIntents),
...
abstract mixin class $BuildTransactionParamsCopyWith<$Res> {
  factory $BuildTransactionParamsCopyWith(BuildTransactionParams value,
          $Res Function(BuildTransactionParams) _then) =
      _$BuildTransactionParamsCopyWithImpl;
  @useResult
  $Res call({List<PaymentIntentParams> paymentIntents, dynamic capabilities});
}
...
class _$BuildTransactionParamsCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? paymentIntents = null,
    Object? capabilities = freezed,
  }) {
    return _then(_self.copyWith(
      paymentIntents: null == paymentIntents
          ? _self.paymentIntents
          : paymentIntents // ignore: cast_nullable_to_non_nullable
              as List<PaymentIntentParams>,
...
extension BuildTransactionParamsPatterns on BuildTransactionParams {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BuildTransactionParams value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _BuildTransactionParams implements BuildTransactionParams {
  const _BuildTransactionParams(
      {required final List<PaymentIntentParams> paymentIntents,
      this.capabilities})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BuildTransactionParamsCopyWith<_BuildTransactionParams> get copyWith =>
      __$BuildTransactionParamsCopyWithImpl<_BuildTransactionParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BuildTransactionParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _BuildTransactionParams &&
            const DeepCollectionEquality()
                .equals(other._paymentIntents, _paymentIntents) &&
            const DeepCollectionEquality()
                .equals(other.capabilities, capabilities));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_paymentIntents),
      const DeepCollectionEquality().hash(capabilities));
...
/// @nodoc
abstract mixin class _$BuildTransactionParamsCopyWith<$Res>
    implements $BuildTransactionParamsCopyWith<$Res> {
  factory _$BuildTransactionParamsCopyWith(_BuildTransactionParams value,
          $Res Function(_BuildTransactionParams) _then) =
      __$BuildTransactionParamsCopyWithImpl;
  @override
  @useResult
  $Res call({List<PaymentIntentParams> paymentIntents, dynamic capabilities});
}
...
mixin _$CheckTransactionParams {
  String get id;
  String get sendResult;

  /// Create a copy of CheckTransactionParams
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CheckTransactionParamsCopyWith<CheckTransactionParams> get copyWith =>
      _$CheckTransactionParamsCopyWithImpl<CheckTransactionParams>(
          this as CheckTransactionParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CheckTransactionParams &&
...
abstract mixin class $CheckTransactionParamsCopyWith<$Res> {
  factory $CheckTransactionParamsCopyWith(CheckTransactionParams value,
          $Res Function(CheckTransactionParams) _then) =
      _$CheckTransactionParamsCopyWithImpl;
  @useResult
  $Res call({String id, String sendResult});
}
...
extension CheckTransactionParamsPatterns on CheckTransactionParams {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CheckTransactionParams value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String sendResult)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _CheckTransactionParams implements CheckTransactionParams {
  ...
  factory _CheckTransactionParams.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CheckTransactionParamsCopyWith<_CheckTransactionParams> get copyWith =>
      __$CheckTransactionParamsCopyWithImpl<_CheckTransactionParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CheckTransactionParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CheckTransactionParams &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.sendResult, sendResult) ||
                other.sendResult == sendResult));
  }
...
/// @nodoc
abstract mixin class _$CheckTransactionParamsCopyWith<$Res>
    implements $CheckTransactionParamsCopyWith<$Res> {
  factory _$CheckTransactionParamsCopyWith(_CheckTransactionParams value,
          $Res Function(_CheckTransactionParams) _then) =
      __$CheckTransactionParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String sendResult});
}
