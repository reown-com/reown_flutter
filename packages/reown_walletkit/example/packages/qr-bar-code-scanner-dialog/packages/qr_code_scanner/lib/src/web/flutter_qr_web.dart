...
class QRViewControllerWeb implements QRViewController {
  ...
  Future<bool?> getFlashStatus() async {
    // flash is simply not supported by JavaScipt. To avoid issuing applications, we always return it to be off.
    return false;
  }

  @override
  Future<SystemFeatures> getSystemFeatures() {
    // implement getSystemFeatures
    throw UnimplementedError();
  }

  @override
  // implement hasPermissions. Blocking: WebQrView.cameraAvailable() returns a Future<bool> whereas a bool is required
  ...
  Future<void> stopCamera() {
    // implement stopCamera
    throw UnimplementedError();
  }

  @override
  Future<void> toggleFlash() async {
    // flash is simply not supported by JavaScipt
    return;
  }

  @override
  Future<void> scanInvert(bool isScanInvert) {
    // implement scanInvert
    throw UnimplementedError();
  }
}
